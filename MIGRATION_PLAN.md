...
- AWS-shaped incident workflows, commands, evidence sources, whiteboards, and adversarial follow-ups.
...
| Terraform state and recovery | Netflix and AWS tracks | `core/infrastructure-as-code/terraform-state-integrity.md` | AWS Round 1 and 2 sources added; canonical migration planned |
| GitOps and progressive delivery | AWS Round 1 and 2 | `core/delivery-gitops/` | AWS source added; canonical migration planned |
...
### Round 2 — complete in `aws-round-2-incident-response`

- `tracks/aws/round-2/07-route53-to-application-outage.md`
- `tracks/aws/round-2/08-eks-api-latency-doubles.md`
