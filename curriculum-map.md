...
| AWS Round 2 request-path outage chapter | `core/networking/`, `core/incident-response/request-path-debugging.md` |
| AWS Round 2 latency chapter | `core/observability/`, `core/reliability/latency-analysis.md` |
| AWS Round 2 cohort-failure chapter | `core/incident-response/cohort-analysis.md`, `core/delivery-gitops/progressive-delivery.md` |
...
| AWS Round 2 restart chapter | `core/kubernetes/runtime-debugging.md`, `core/linux/` |
| AWS Round 2 postmortem chapter | `core/incident-response/postmortems.md`, `core/leadership/` |
...
| EKS API latency doubles | `tracks/aws/round-2/08-eks-api-latency-doubles.md` | RED/USE, histograms, tracing, profiling, dependency saturation |
